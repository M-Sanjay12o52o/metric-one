...
CREATE TABLE `Quizz` (
    ...
    UNIQUE INDEX `Quizz_name_key`(`name`),
    INDEX `Quizz_name_idx`(`name`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
-- AddForeignKey
ALTER TABLE `Quizz` ADD CONSTRAINT `Quizz_creatorId_fkey` FOREIGN KEY (`creatorId`) REFERENCES `User`(`id`) ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `Subscription` ADD CONSTRAINT `Subscription_userId_fkey` FOREIGN KEY (`userId`) REFERENCES `User`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `Subscription` ADD CONSTRAINT `Subscription_quizzId_fkey` FOREIGN KEY (`quizzId`) REFERENCES `Quizz`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
